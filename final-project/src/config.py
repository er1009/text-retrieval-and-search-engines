...
class NeuralConfig:
    ...
    cross_encoder_batch_size: int = 256  # A100 80GB can handle large batches
    cross_encoder_max_length: int = 512
    
    # MonoT5
    monot5_model: str = "castorini/monot5-base-msmarco"  # Use base for speed, 3b for quality
    monot5_batch_size: int = 64
    monot5_max_length: int = 512
    
    # Ensemble weight (cross_encoder weight, monot5 = 1 - ce_weight)
    ce_weight: float = 0.5
    
    # Reranking depth
    rerank_depth: int = 100  # Top-k docs from BM25 to rerank
