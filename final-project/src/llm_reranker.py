...
# Few-shot examples from DIFFERENT DIFFICULTY LEVELS for better calibration
...
FEW_SHOT_EXAMPLES = """
EXAMPLE 1 (Easy query - many relevant docs exist):
Query: "international organized crime"

[1] Colombian Prosecutor General Gustavo de Greiff said the U.S. Government is not interested in supplying evidence to condemn the chiefs of the drug trafficking mafia. De Greiff reaffirmed difficulties collecting evidence against the main "capos" of the Cali cartel.

[2] State of the Nation Address by President Guillermo Endara at the Legislative Palace in Panama City: Your Excellencies, president of the Legislative Assembly; president of the Supreme Court of Justice...

[3] National Drug Directorate Director has said the fight against drug trafficking in the world has not failed because it has not even begun yet in many countries. Colombia continues to be the world's top producer and exporter of cocaine.

{"reasoning": "Doc 1: HIGHLY - Cali cartel mafia prosecution. Doc 3: HIGHLY - international drug cartels. Doc 2: NOT - government address, no crime.", "ranking": [1, 3, 2]}

EXAMPLE 2 (Hard query - very few relevant docs, need precision):
Query: "rap crime"

[1] Two members of the rap group House of Pain were arrested on charges of assaulting a bartender. The incident occurred after a concert in Boston.

[2] Grammy Awards ceremony honored the year's best music. Whitney Houston won Record of the Year. The hip-hop category saw strong competition.

[3] Tupac Shakur, the rapper, was shot five times in a robbery at a New York recording studio. He survived but faced ongoing legal troubles including sexual assault charges.

{"reasoning": "Doc 3: HIGHLY - rapper Tupac shot, legal troubles, direct crime connection. Doc 1: MEDIUM - rap group arrested for assault. Doc 2: NOT - music awards, no crime.", "ranking": [3, 1, 2]}

EXAMPLE 3 (Medium query - selective relevance):
Query: "pope beatifications"

[1] Pope John Paul II beatified 45 martyrs who died during the Spanish Civil War, moving them one step closer to sainthood. The ceremony at St. Peter's Square drew thousands of pilgrims.

[2] The Vatican announced the Pope's upcoming visit to Denver for World Youth Day. Preparations include security arrangements and logistics for the mass gathering.

[3] Cardinal Joseph Ratzinger discussed the process of canonization, noting that beatification requires proof of a miracle attributed to the candidate's intercession.

{"reasoning": "Doc 1: HIGHLY - beatification ceremony, martyrs, sainthood. Doc 3: HIGHLY - beatification process explained. Doc 2: LOW - Pope's visit but no beatification.", "ranking": [1, 3, 2]}
"""
