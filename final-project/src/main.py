...
def cmd_quick_train(args):
    ...
    chunk_size = getattr(args, 'chunk_size', 384)
    chunk_overlap = getattr(args, 'chunk_overlap', 96)
    ...
    for qid in tqdm(train_qids, desc="  Processing"):
        ...
        doc_scores = aggregate_passage_scores(passages, passage_scores, doc_to_indices, strategy="hybrid")
